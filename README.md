...
## Notes
This is a fork written for the sole purpose of providing PerceptionLM support in TransformerLens by adding some minor weight rewrapping. 
See [this notebook](demos/PerceptionLM_Demo.ipynb).
